...
pc.printf("Valid OBD-II PID reply\n\r");
 /* Details from OBD-II PIDs - Wikipedia, the free encyclopedia */
 switch (can_MsgRx.data[2]) { /* Details from OBD-II PIDs - Wikipedia, the free encyclopedia */
